...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-push-8">
            ...
            <!-- Start Sign In Form -->
            <form action="signuplast" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post">
                <h2>输入从邮箱获得的验证码</h2>
                <div class="form-group">
                    <label for="verification" class="sr-only">Verification</label>
                    <input type="text" class="form-control" name="verification" id="verification" placeholder="Verification" autocomplete="off">
                </div>
                <%--<div class="form-group">--%>

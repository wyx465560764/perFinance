...
<div class="container">
	<div class="row">
		...
		<!--&lt;!&ndash;<li><a href="index.html">Style 1</a></li>&ndash;&gt;-->
		<!--&lt;!&ndash;<li><a href="index2.html">Style 2</a></li>&ndash;&gt;-->
		<!--&lt;!&ndash;<li class="active"><a href="index.jsp">Style 3</a></li>&ndash;&gt;-->
		<!--&lt;!&ndash;</ul>&ndash;&gt;-->
		<!--</div>-->
	</div>
	<div class="row">
		<div class="col-md-4 col-md-push-8">
			...
			<form action="login" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post">
				...
				<%--</div>--%>
				<div class="form-group">
					<p>没有注册？ <a href="sign-up.jsp">注册</a> | <a href="forgot.jsp">忘记密码？</a></p>
				</div>
				<div class="form-group">

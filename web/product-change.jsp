...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <%--&lt;%&ndash;<li class="layui-nav-item"><a href="product-earn.jsp">理财收益管理</a></li>&ndash;%&gt;--%>
        ...
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
                <table class="layui-table">
                    ...
                    <%
                        try {
                            List<product> productList= productDAO.getInstance().SelectProductDetail(session.getAttribute("userid").toString());
                    ...
                    <tr>
                        ...
                        <td><%=e.getNowprice()%></td>
                        <td><a class="layui-btn layui-btn-sm layui-btn-normal" href="product-change-last.jsp?productid=<%=e.getProductid()%>">修改</a></td>
                        <%--<td><%=Num%></td>--%>
                        <%}
                            Num++;
                        %>
                ...
                <div style="text-align: center;">
                    ...
                    <a href="product-change.jsp?page=<%=Page-1%>" class="layui-btn">上一页</a>
                    ...
                    <a href="product-change.jsp?page=<%=Page+1%>" class="layui-btn">下一页</a>

...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-push-8">
            ...
            <!-- Start Sign In Form -->
            <form action="identity" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post">
                <h2>实名验证</h2>
                <div class="form-group">
                    <label for="identity" class="sr-only">Verification</label>
                    <input type="text" class="form-control" name="identity" id="identity" placeholder="identity" autocomplete="off">
                </div>
                <%--<div class="form-group">--%>
                ...
                <label>提示：请认真核对，一经提交将不可修改</label>
            </form>
            <!-- END Sign In Form -->

...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="text-align: center;">
            ...
            <a href="market-unfixedincome.jsp?type=<%=request.getParameter("type")%>&page=<%=Page-1%>" class="layui-btn">上一页</a>
            ...
            <a href="market-unfixedincome.jsp?type=<%=request.getParameter("type")%>&page=<%=Page+1%>" class="layui-btn">下一页</a>
